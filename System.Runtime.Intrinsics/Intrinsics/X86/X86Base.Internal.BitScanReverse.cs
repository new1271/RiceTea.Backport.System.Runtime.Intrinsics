...
#if B32_ARCH || ANYCPU
        public static ref readonly byte BsrData_Unix_X86 => ref Unwrap.From(new byte[BsrLength_Unix_X86]
        {
            0x0F, 0xBD, 0x44, 0x24, 0x04 // bsr eax, dword ptr [esp+4]
        });
#endif
#if B64_ARCH || ANYCPU
        public static ref readonly byte BsrData_Unix_X64 => ref Unwrap.From(new byte[BsrLength_Unix_X64]
        {
