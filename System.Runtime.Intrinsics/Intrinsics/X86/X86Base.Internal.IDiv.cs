...
unsafe partial class X86Base
{
    ...
    private static void InjectIDivAsm_Windows_X86(ref void* destination, ref uint length)
    {
        ...
        if (!_spanExists)
        {
            UnsafeHelper.CopyBlockUnaligned(destination, in StoreAsArray.GetIDivDataReference_Windows_X86(), Length);
            return;
        }
#endif
        UnsafeHelper.CopyBlockUnaligned(destination, in StoreAsSpan.GetIDivDataReference_Windows_X86(), Length);
    }
    ...
    private static void InjectIDivAsm_Unix_X86(ref void* destination, ref uint length)
    {
        ...
        if (!_spanExists)
        {
            UnsafeHelper.CopyBlockUnaligned(destination, in StoreAsArray.GetIDivDataReference_Unix_X86(), Length);
            return;
        }
#endif
        UnsafeHelper.CopyBlockUnaligned(destination, in StoreAsSpan.GetIDivDataReference_Unix_X86(), Length);
    }
#endif
    ...
    private static void InjectIDivAsm_Windows_X64(ref void* destination, ref uint length)
    {
        ...
        if (!_spanExists)
        {
            UnsafeHelper.CopyBlockUnaligned(destination, in StoreAsArray.GetIDivDataReference_Windows_X64(), Length);
            return;
        }
#endif
        UnsafeHelper.CopyBlockUnaligned(destination, in StoreAsSpan.GetIDivDataReference_Windows_X64(), Length);
    }
    ...
    private static void InjectIDivAsm_Unix_X64(ref void* destination, ref uint length)
    {
        ...
        if (!_spanExists)
        {
            UnsafeHelper.CopyBlockUnaligned(destination, in StoreAsArray.GetIDivDataReference_Unix_X64(), Length);
            return;
        }
#endif
        UnsafeHelper.CopyBlockUnaligned(destination, in StoreAsSpan.GetIDivDataReference_Unix_X64(), Length);
    }
#endif
